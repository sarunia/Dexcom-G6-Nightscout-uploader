...
const char *AP_SSID = "xxxxxx";                       // WiFi SSID
const char *AP_PWD = "yyyyyyyy";                      // WiFi password
...
void postDataToServer()
{
  ...
  {
    HTTPClient https;   
    https.begin("https://xxxxxxxxxx.herokuapp.com/api/v1/entries");   //https://your-NS-site.herokuapp.com/api/v1/entries
