...
void postDataToServer()
{
...

  {
    ...
    doc["pump"]["extended"]["Session time since start (seconds)"] = currentTime - sessionStartTime;
    doc["pump"]["extended"]["Session days"] = (currentTime - sessionStartTime) / (60*60*24);
    doc["pump"]["extended"]["Session hours"] = ((currentTime - sessionStartTime) / (60*60)) % 24;
    doc["pump"]["extended"]["Last calibration"] = calibration;
    doc["pump"]["extended"]["Last calibration timestamp"] = calibrationTime;
    doc["pump"]["extended"]["Last calibration days ago"] = (currentTime - calibrationTime) / (60*60*24);
    doc["pump"]["extended"]["Last calibration hours ago"] = ((currentTime - calibrationTime) / (60*60)) % 24;
    doc["pump"]["extended"]["Trend"] = trend;
    String requestBody;
